...
import GroceryFoodCategoryLookupSpec from "./GroceryFoodCategoryLookupSpec.js";
...
export default class GroceryFoodCategoryLookupQuery extends DerivedQuery<GroceryFoodCategoryLookup> {
  static create(ctx: Context) {
    return new GroceryFoodCategoryLookupQuery(
      ctx,
      QueryFactory.createSourceQueryFor(ctx, GroceryFoodCategoryLookupSpec),
      modelLoad(ctx, GroceryFoodCategoryLookupSpec.createFrom)
    );
  }
