	...
	return (
		<div
			className={classNames(
				'relative animate-ease-default animate-forwards overflow-hidden [&[data-state=closed]]:(animate-peek-close animate-duration-300 max-h-[var(--peek-height,120px)]) [&[data-state=open]]:(animate-peek-open animate-duration-300)',
				className,
			)}
			ref={containerRef}
