...
const StyledContent = withClassName(
	...
	'[&[data-state=open][data-side=right]]:animate-fade-in-left',
	'[&[data-state=open][data-side=bottom]]:animate-fade-in-up',
	'[&[data-state=open][data-side=left]]:animate-fade-in-right',
	'[&[data-state=closed][data-side=top]]:animate-fade-out-up',
	'[&[data-state=closed][data-side=right]]:animate-fade-out-right',
	'[&[data-state=closed][data-side=bottom]]:animate-fade-out-down',
