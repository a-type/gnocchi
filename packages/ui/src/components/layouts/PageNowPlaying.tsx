	...
	return (
		<div
			...
			className={classNames(
				'fixed bottom-[var(--now-playing-bottom,60px)] left-0 right-0 z-now-playing w-full flex flex-col gap-2 items-end',
				...
				unstyled
					? 'p-2'
					: 'layer-components:(bg-wash p-2px rounded-xl border-light shadow-md min-w-32px items-center justify-center m-2)',
				className,
			)}
		/>
	);
