...
INSERT INTO "new_plans" ("created_at", "deleted_at", "id", "stripe_customer_id", "stripe_subscription_id", "subscription_canceled_at", "subscription_expires_at", "subscription_status", "updated_at") SELECT "created_at", "deleted_at", "id", "stripe_customer_id", "stripe_subscription_id", "subscription_canceled_at", "subscription_expires_at", "subscription_status", "updated_at" FROM "plans";
DROP TABLE "plans";
