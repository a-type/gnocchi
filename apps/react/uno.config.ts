...
export default defineConfig({
	theme: {
		colors: {
			...
			gray1: 'var(--color-gray-10)',
			gray2: 'var(--color-gray-20)',
			gray3: 'var(--color-gray-30)',
			gray4: 'var(--color-gray-40)',
			gray5: 'var(--color-gray-50)',
			gray6: 'var(--color-gray-60)',
			gray7: 'var(--color-gray-70)',
			gray8: 'var(--color-gray-80)',
			gray9: 'var(--color-gray-90)',
	...
	shortcuts: {
		...
		'z-nav': 'z-[calc(--z-nav)]',
		'z-menu': 'z-[calc(--z-menu)]',
		'z-dialog': 'z-[calc(--z-dialog)]',
		'z-dialog-backdrop': 'z-[calc(--z-dialogBackdrop)]',
		'z-tooltip': 'z-[calc(--z-tooltip)]',
		'z-overdraw': 'z-[calc(--z-overdraw)]',
	},
