	...
	return (
		<PageRoot>
			<PageContent>
				...
				<p>
					We use a limited amount of Your Personal data to provide and improve
				...
				>
					<p>
						...
						very little data, and most of it is what you provide if you choose
						to sign up for a subscription.
					</p>
					<p>
						For anonymous, local-only users - only completely anonymized
						category assignment information about items in your list is
						collected, and only for the default categories. This helps me give
						everyone better category suggestions. I also collect analytics
						("Usage Data") about how you access and use the app, only so I can
						understand how to do a good job providing it for everyone and
						whether any promotions I'm running are effective.
					</p>
					<p>
						For subscribers with an Account, in addition to the data collected
						for anonymous users above, I will store your name and email address,
						so you can log in and be recognized by others. If you sign in with a
				...
				<ul>
					...
					<li>
						<p>
							<strong>Application</strong> refers to Gnocchi, the software
					...
					<li>
						<p>
							...
							in this Agreement) refers to Gnocchi.
						</p>
					</li>
					<li>
						<p>
				...
				<p>
					...
					account, such as Your name and Your email address.
				</p>
				<p>
