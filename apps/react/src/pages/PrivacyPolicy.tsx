...
export function PrivacyPolicy() {
	return (
		<PageContent>
			...
			<p>
				We use a limited amount of Your Personal data to provide and improve the
			...
			<div className="color-accent-ink bg-accent-wash p-3 rounded-md">
				<p>
					...
					privacy policy, but if you're wondering, Gnocchi collects very little
					data, and most of it is what you provide if you choose to sign up for
					a subscription.
				</p>
				<p>
				...
				<p>
					...
					including your list, categories, and recipes. This is simply necessary
					in order to synchronize it. You still own your data, see{' '}
			...
			<ul>
				...
				<li>
					<p>
						<strong>Application</strong> refers to Gnocchi, the software program
				...
				<li>
					<p>
						...
						this Agreement) refers to Gnocchi.
					</p>
				</li>
				<li>
					<p>
			...
			<p>
				...
				such as Your name and Your email address.
			</p>
			<p>
